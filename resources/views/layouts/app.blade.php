...
<head>
    ...
    <meta name="description" content="Architect your resume!">
    <meta property="og:title" content="{{ config('app.name', 'ARC') }}" />
    ...
    <RouterLink rel="manifest" href="/manifest.json" crossorigin="use-credentials">
        <RouterLink rel="preconnect" href="https://fonts.googleapis.com">
            <RouterLink rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
