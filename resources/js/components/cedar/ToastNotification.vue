...
import type { SwipeDirection, ToastProps } from '@/types/cedar';
        ...
        >
            <span
                :class="[
                    ...
                    'dark:bg-primary-dark-700/70 bg-white text-gray-800 shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] dark:text-neutral-100',
                    'ring-1 ring-gray-100 ring-inset dark:ring-neutral-800/50',
                    '!outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-indigo-500',
                ]"
                v-show="isMounted"
            >
                <div
                ...
                <p
                    ...
                    class="scrollbar-minimal mt-1.5 max-h-32 min-h-3 w-full overflow-y-auto pe-2 text-xs leading-tight break-words whitespace-pre-wrap opacity-70"
                >
                    {{ description }}
                </p>
                <template v-if="!props.html">
                    <span
                        @click="onClose"
                        class="absolute right-0 mr-2.5 cursor-pointer rounded-full p-1.5 text-gray-400 opacity-0 duration-100 ease-in-out hover:bg-gray-50 hover:text-gray-500 dark:bg-gray-800/50 dark:text-rose-700 dark:hover:text-rose-600"
                        :class="{
