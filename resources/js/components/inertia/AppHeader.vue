...
import UserMenuContent from '@/components/inertia/UserMenuContent.vue';
import { getInitials } from '@/composables/inertia/useInitials';
...
const rightNavItems: NavItem[] = [
    {
        title: 'Repository',
        href: 'https://github.com/aminnausin/arc',
        icon: Folder,
    },
];
</script>
                    ...
                    <NavigationMenu class="ml-10 flex h-full items-stretch">
                        <NavigationMenuList class="flex h-full items-stretch space-x-2">
                            <NavigationMenuItem v-for="(item, index) in mainNavItems" :key="index" class="relative flex h-full items-center">
                                <RouterLink :class="[navigationMenuTriggerStyle(), activeItemStyles(item.href), 'h-9 cursor-pointer px-3']" :to="item.href">
