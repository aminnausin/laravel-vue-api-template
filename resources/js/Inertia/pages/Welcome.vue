...
<template>
    <Head title="Welcome">
        <RouterLink rel="preconnect" href="https://rsms.me/" />
        <RouterLink rel="stylesheet" href="https://rsms.me/inter/inter.css" />
    </Head>
            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    >
                        ...
                        <g :style="`mixBlendMode: 'plus-darker'`" class="translate-y-0 opacity-100 transition-all delay-300 duration-750 starting:translate-y-4 starting:opacity-0">
                            <path
